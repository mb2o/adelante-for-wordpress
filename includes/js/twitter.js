(function($) {
  ...
  $.fn.tweet = function(o){
    var s = {
      username: ["mb2o"],              // [string]   required, unless you want to display our tweets. :) it can be an array, just do ["username1","username2","etc"]
      ...
      $(widget).bind("load", function(){
        $.getJSON(build_url(), function(data){
          ...
          $.each(tweets, function(i,item){
            ...
            var avatar_template = '<div class="tweet_avatar thumbnail"><a href="http://twitter.com/'+from_user+'"><img src="'+profile_image_url+'" height="'+s.avatar_size+'" width="'+s.avatar_size+'" alt="'+from_user+'\'s avatar" title="'+from_user+'\'s avatar" border="0"/></a></div>';
            ...
            list.append('<li><div class="tweet_wrapper">' + avatar + '<div class="tweet_details">' + date + join + text + '</div></div></li>');
