 ...
 */
class adelante_widget_related extends WP_Widget 
{
	function adelante_widget_related() 
    {
		$widget_ops = array('classname' => 'widget_related_posts', 'description' => __( "Displays the related posts on your site", 'adelante') );
		$this->WP_Widget('related_posts', THEME_SLUG.' - '.__('Related Posts', 'adelante'), $widget_ops);
...
?>
		...
		<p>
			<label for="<?php echo $this->get_field_id('cat'); ?>"><?php _e( 'Categorys:' , 'adelante'); ?></label>
