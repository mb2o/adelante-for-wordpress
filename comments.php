<?php function adelante_comments($comment, $args, $depth) {
...
<?php if ( have_comments() ) : ?>
	<section id="comments">
		...
		<?php wp_list_comments('type=comment&callback=adelante_comments'); ?>
...
<!--			<nav id="comments-nav">
				<div class="comments-previous"><?php //previous_comments_link( __( '&larr; Older comments', 'adelante' ) ); ?></div>
				<div class="comments-next"><?php //next_comments_link( __( 'Newer comments &rarr;', 'adelante' ) ); ?></div>
			</nav>   -->
		</footer>
	</section>
...
<section id="respond">
	...
	<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
		...
		<p><input name="submit" class="adelante-button" type="submit" id="submit" tabindex="5" value="Submit Comment"></p>
